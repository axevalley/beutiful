...
REPO_URL = 'ssh://lseagle@lsgit.uk/~/lsgit.uk/beutiful.git'
...
def _update_settings(source_folder, site_name):
    settings_path = source_folder + '/beutiful/settings.py'
    sed(settings_path, "DEBUG = True", "DEBUG = False")
    sed(
        settings_path, 'ALLOWED_HOSTS =.+$',
        'ALLOWED_HOSTS = ["{}"]'.format(site_name))
    secret_key_file = source_folder + '/beutiful/secret_key.py'
